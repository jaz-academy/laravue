...
const route = useRoute('profile-student-account-tab')
...
definePage({ meta: { navActiveLink: 'profile-student-account-tab' } })
</script>
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: 'profile-student-account-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
